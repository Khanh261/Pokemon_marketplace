...
const RARITY_PRICE_MAP = {
    [pokemon_entity_1.PokemonRarity.COMMON]: '0.001',
    [pokemon_entity_1.PokemonRarity.UNCOMMON]: '0.003',
    [pokemon_entity_1.PokemonRarity.RARE]: '0.006',
    [pokemon_entity_1.PokemonRarity.LEGENDARY]: '0.01',
};
let SeedService = class SeedService {
    pokemonRepository;
    userRepository;
    configService;
    constructor(pokemonRepository, userRepository, configService) {
    ...
    async seedUsers() {
        const ownerAddress = this.configService.get('OWNER_ADDRESS', '').toLowerCase();
        if (!ownerAddress) {
